...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void SwcNodeDataV1::set_devicetype(ArgT0&& arg0, ArgT... args) {
...
inline std::string* SwcNodeDataV1::mutable_devicetype() {
...
inline void SwcNodeDataV1::set_allocated_devicetype(std::string* devicetype) {
